...
$(document).ready(function () {
  alert("WELCOME TO FOODLIFE MARKET!"); //function to display the delivery textarea once the button has been clicked
  ...
  $(".chainedEffect").click(function () {
    $(".body").css("background", "linear-gradient(to right, crimson, lightcoral").animate({
      right: "600px"
    }, 1000).animate({
      left: "600px"
